...
class RetinaNet(nn.Module):
    ...
    def forward(self, images, targets=None):
        ...
        features, backbone_loss = self.backbone(images.tensors, targets=targets)
        losses.update(backbone_loss)
        ...
        if self.training:
            assert targets is not None
            losses.update(self.compute_loss(targets, head_outputs, anchors))
        else:
            # recover level sizes
