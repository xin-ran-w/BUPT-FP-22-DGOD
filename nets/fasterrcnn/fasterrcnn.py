...
from backbone.adv_net import adv_loss
...
class FasterRCNNBase(nn.Module):
    ...
    def __init__(self, backbone, rpn, roi_heads, transform, hparams):
    ...
    def forward(self, images, targets=None):
        ...
        losses = {}
        images, targets = self.transform(images, targets)  # preprocess the image and targets

        features, backbone_losses = self.backbone(images.tensors, targets)
...
class FasterRCNN(FasterRCNNBase):
    ...
    def __init__(self, backbone, hparams, num_classes=None,
                 # transform parameter
                 min_size=500, max_size=800,      # 预处理resize时限制的最小尺寸与最大尺寸
        ...
        super(FasterRCNN, self).__init__(backbone, rpn, roi_heads, transform, hparams)
